<?php
/**
 * Plugin Name: Project Panorama - WordPress Project Management Plugin
...
// = Localization =
// ================
add_action('plugins_loaded', 'psp_lite_localize_init');
function psp_lite_localize_init() {
...
// ============================
function psp_lite_check_database() {
